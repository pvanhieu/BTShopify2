...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'App Laravel'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '041fa7c5142b24d2964b83b74006dcc7'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'be20255d403ac9a98283f2012c3bf497'),
    ...
    'webhook' => [
        /*
            [
                ...
                'address' => 'https://1acf-113-161-32-170.ap.ngrok.io/webhook/products-create'
            ], [
                 'topic' => 'products/update',
                'address' => 'https://1acf-113-161-32-170.ap.ngrok.io/webhook/products-update'
            ],
            [
        ...
        */
        'topic' => 'products/create',
        'format' => 'json',
        'address' => 'https://1acf-113-161-32-170.ap.ngrok.io/api/createWebhookProduct'
    ],
